...
class AIAnalysisService {
  ...
  getVisionAnalysisPrompt() {
    return `你是金铲铲之战S18教练AI。基于截图识别数据并给出建议。只返回纯JSON。
...
- 羁绊: 屏幕【左侧】，已激活羁绊和数量。S18羁绊含：绽放、裂隙兽、巫会、苍木、灵巧兽、黑荆棘、仙灵、炼狱、适配者、绿父、古树、翠绿之相、赏金猎人、致命花、腐蚀、荆棘少女、化身、顶级捕食者、调谐、宿敌、巨石、怪异、原始、太阳、月亮、法术编织者、掠夺者、斗士、先锋、猎手、行刑官、召唤师、重装战士、守护者、速射、祈求者
...
- 如果某个羁绊只差1个棋子就能触发更高等级（如绽放3→5），在suggestions里提醒
- synergyHint字段：列出"差1个"可激活或升档的羁绊，格式如"差1个卡尔玛激活5绽放"
- 如果阵容已经成型，给出阵容名（如"绽放风暴"、"裂隙兽远古巨龙")

【S18苍林秘境赛季完整英雄名单 - 禁止编造！】
只能推荐以下65个英雄，禁止编造不存在的英雄：
1费(14):阿卡丽/卡蜜尔/小炭/卡尔玛/古布子/蕾欧娜/奥恩/碎石/洛/雷克塞/维鲁斯/维迦/霞/约里克
2费(13):阿利斯塔/凯特琳/伊莉丝/格罗普/凯尔/乐芙兰/暗影狼/斯库特尔/瑟庄妮/慎/提莫/沃里克/优娜拉
3费(14):阿兹尔/卡西奥佩娅/黛安娜/费德提克/赫卡里姆/卡兹克/克格莫/克鲁格/易大师/拉莫斯/锐鹏/雷恩加尔/崔丝塔娜/蔚
4费(14):阿狸/阿木木/古代哨兵/厄斐琉斯/荆棘甲虫/伊泽瑞尔/莉莉娅/墨菲特/莫甘娜/奈德丽/瑟提/希维尔/索拉卡/婕拉
5费(10):阿璐妮/艾希/德莱文/纳尔/艾翁/凯南/拉克丝/茂凯/塔里克/远古巨龙
羁绊归属：绽放(卡尔玛/约里克/优娜拉/易大师/阿狸/瑟提/艾希)、裂隙兽(小炭/碎石/暗影狼/格罗普/斯库特尔/克鲁格/锐鹏/荆棘甲虫/古代哨兵/远古巨龙)、巫会(卡蜜尔/凯特琳/伊莉丝/卡西奥佩娅/莫甘娜)、苍木(奥恩/阿利斯塔/乐芙兰/赫卡里姆/霞/伊泽瑞尔/纳尔)、灵巧兽(古布子/维迦/提莫/崔丝塔娜/拉莫斯/纳尔)、仙灵(洛/霞/崔丝塔娜/莉莉娅)、炼狱(阿卡丽/维鲁斯/慎/阿木木/凯南)、适配者(阿卡丽/格罗普/易大师/克格莫/奈德丽)、怪异(雷克塞/维迦/沃里克/阿兹尔/墨菲特)、原始(蔚/希维尔/奈德丽)、太阳(蕾欧娜/凯尔/瑟庄妮/阿璐妮)、月亮(黛安娜/厄斐琉斯/阿璐妮)、宿敌(卡兹克/雷恩加尔)、法术编织者(卡尔玛/维迦/卡西奥佩娅/乐芙兰/阿狸/阿璐妮)、掠夺者(阿卡丽/卡蜜尔/暗影狼/黛安娜/荆棘甲虫/沃里克)、斗士(古布子/阿利斯塔/克鲁格/瑟提/纳尔/雷克塞)、先锋(洛/伊莉丝/赫卡里姆/黛安娜/古代哨兵/塔里克)、猎手(小炭/凯特琳/崔丝塔娜/希维尔/艾希)、行刑官(优娜拉/阿兹尔/伊泽瑞尔/索拉卡/凯南)、召唤师(约里克/阿兹尔/锐鹏/婕拉)、重装战士(洛/约里克/斯库特尔/瑟庄妮/蔚/阿木木/茂凯)、守护者(蕾欧娜/奥恩/慎/费德提克/拉莫斯/莉莉娅)、速射(维鲁斯/霞/凯尔/锐鹏/崔丝塔娜/厄斐琉斯)、祈求者(碎石/提莫/克格莫/古代哨兵/莫甘娜)、绿父(艾翁)、古树(茂凯)、翠绿之相(塔里克)、赏金猎人(德莱文)、致命花(费德提克/索拉卡)、腐蚀(克格莫)、荆棘少女(婕拉)、化身(拉克丝)、顶级捕食者(远古巨龙)、调谐(阿璐妮)、巨石(墨菲特)
...
1. icon: 表情符号（如💰、🔗、📈等）
2. title: 简短标题（如"花20金D牌"、"找1张卡尔玛"）
3. content: 【必须包含】具体数值阈值 + 具体操作步骤，例如：
   ✅ 正确："金币50，花20金D两下，找1张卡尔玛激活3绽放，剩余30金吃3利息"
   ✅ 正确："血量45安全，花30金D找瑟提/阿狸，凑齐5绽放后锁血"
   ❌ 错误："建议D牌"（无数值无步骤）
   ❌ 错误："绽放差1个"（没说找谁）
...
示例: {"phase":"3-1","gold":"50","health":"59","level":"6","synergies":[{"name":"绽放","count":2},{"name":"斗士","count":2}],"teamName":"绽放斗士雏形","synergyHint":"差1个卡尔玛激活3绽放，差1个斗士激活4斗士","suggestions":[{"icon":"🔗","title":"花20金D找卡尔玛","content":"金币50，花20金D两下，找1张卡尔玛激活3绽放，剩余30金吃3利息"},{"icon":"💰","title":"保持金币吃息","content":"当前50金吃满5利息，升7需24金，升7后剩26金可D两下找瑟提"},{"icon":"📈","title":"升级时机","content":"当前6级，建议3-2升7人口，7级后4费卡概率15%，可找瑟提/阿狸"}],"upgradeHint":"当前6级升7需24金币(12经验)，建议3-2升7后剩26金币吃2利息","rollHint":"血量59安全，阵容2绽放+2斗士成型中，暂不D牌存利息","equipmentHint":"优先给瑟提合羊刀(弓+大棒)叠攻速，其次给奥恩合日炎(腰带+锁子甲)前排坦度"}
`
  }
...
S18赛季羁绊：绽放、裂隙兽、巫会、苍木、灵巧兽、黑荆棘、仙灵、炼狱、适配者、绿父、古树、翠绿之相、赏金猎人、致命花、腐蚀、荆棘少女、化身、顶级捕食者、调谐、宿敌、巨石、怪异、原始、太阳、月亮、法术编织者、掠夺者、斗士、先锋、猎手、行刑官、召唤师、重装战士、守护者、速射、祈求者。`
  }
