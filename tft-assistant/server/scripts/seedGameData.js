...
const synergies = [
  ...
  { name: '怪兽', type: 'trait', icon: '👾', effect: '无羁绊但更强属性', levels: [1], color: '#f97316' },
  { name: '星之守护者', type: 'trait', icon: '⭐', effect: '额外获得法力值', levels: [3, 5, 7, 9], color: '#fbbf24' },
  { name: '小天才', type: 'trait', icon: '🧒', effect: '每回合制造改装武器', levels: [3, 5], color: '#fb923c' },
  ...
  { name: '堕落使者', type: 'trait', icon: '💀', effect: '吸收灵魂获得法强', levels: [1], color: '#be123c' },
  ...
  { name: '灵能使', type: 'class', icon: '🔮', effect: '每5秒投掷魔法球', levels: [2, 4, 6], color: '#f59e0b' },
  { name: '爱心使者', type: 'class', icon: '❤️', effect: '施放技能全队叠法强', levels: [2, 4, 6], color: '#ef4444' },
  { name: '情报特工', type: 'class', icon: '🎯', effect: '技能攻击最远敌人', levels: [2, 3, 4], color: '#3b82f6' },
  { name: '秘术卫士', type: 'class', icon: '✨', effect: '提供魔抗加成', levels: [2, 4, 6], color: '#14b8a6' },
